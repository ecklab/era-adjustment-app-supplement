...
row_name <- data.frame(rank = c(seq(1,25), 'pre-1950 in top 10', 'pre-1950 in top 25', 'proportion before 1950'))

kable(cbind(row_name, WAR_rankings)) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
career_fullhouse <- (batcar_year %>% 
                       filter(AB >= 3000, rookie_year <= 2012) %>% 
  arrange(desc(BA)))
...
row_name <- data.frame(rank = c(seq(1,25), 'pre-1950 in top 10', 'pre-1950 in top 25', 'proportion before 1950', 'MLB-eligible population'))

knitr::kable(cbind(row_name, combined_AVG)) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
career_fullhouse_HR_AB <- batcar_year %>% mutate(HR_AB = HR / AB) %>%
  filter(rookie_year <= 2006, AB >= 3000) %>% left_join(rookie_year) %>% 
  arrange(desc(HR_AB))
...
combined_HR <- rbind(combined_HR, c('1871-2023', '1871-2006', '1901-1996', '1871-1993', '1876-2003', '1876-1988', '1871-2006'))
...
kable(cbind(row_name, combined_HR)) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
OBP_fullhouse <- (batcar_year %>% 
                    filter(PA >= 3000, rookie_year <= 2012) %>%
  arrange(desc(OBP)))
...
kable(cbind(row_name, combined_OBP)) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
BA_OBP_HR <- rbind(BA_OBP_HR, c('1871-2012','', '1871-2012','', '1871-2006',''))
...
knitr::kable(cbind(row_name, BA_OBP_HR)) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
kable(cbind(row_name, ebWAR_efWAR_b)) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
zz_ERA <- (pitcar_year %>% arrange(ERA) %>% 
             filter(IP >= 1500) %>% filter(rookie_year <= 2012) )
...
kable(cbind(row_name, IP_ERA_K)) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```

## Table 6: Top 25 bWAR and fWAR leaders for MLB pitchers in the Supplementary materials.
...
kable(cbind(row_name, ebWAR_efWAR_p)) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
## Year Effect on the Era-adjusted WAR of the Hypothetical Batters from 2022

In this section we calculate the bWAR talent of a hypothetical 2023 hitter with 0 bWAR. Then, we compute his era-adjusted bWAR by mapping this hypothetical player to the other seasons from 1871 through 2022. 
...
Then we also calculate the fWAR talent of a hypothetical 2023 hitter with 0 fWAR. Then, we compute his era-adjusted fWAR by mapping this hypothetical player to the other seasons from 1871 through 2022. 
...
Here are the results of the top 25 bWAR and fWAR for batters with respect to this sensitivity analysis. 

```{r echo=FALSE}
rm_comp <- cbind(bat_career_nonpara %>% select(name, ebWAR) %>% slice(1:25), 
                 bat_career_1950 %>% select(name, ebWAR) %>% slice(1:25),
                 bat_career_1994 %>% select(name, ebWAR) %>% slice(1:25))
colnames(rm_comp) <- c('without rm', 'ebWAR', 'rm after 1950', 'ebWAR', 'rm after 1994', 'ebWAR')
kable(rm_comp) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))

rm_comp <- cbind(bat_career_nonpara %>% select(name, efWAR) %>% 
    arrange(desc(efWAR)) %>% slice(1:25), 
                 bat_career_1950 %>% select(name, efWAR) %>% 
    arrange(desc(efWAR))%>% slice(1:25),
                 bat_career_1994 %>% select(name, efWAR) %>% 
    arrange(desc(efWAR))%>% slice(1:25))
colnames(rm_comp) <- c('without rm', 'efWAR', 'rm after 1950', 'efWAR', 'rm after 1994', 'efWAR')
kable(rm_comp) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
Here are the results of the top 25 bWAR and fWAR for pitchers with respect to this sensitivity analysis. 

```{r echo=FALSE}
rm_comp <- cbind(pit_career %>% ungroup() %>% arrange(desc(ebWAR))%>% select(name, ebWAR) %>% slice(1:25), 
                 pit_career_1950 %>% select(name, ebWAR) %>% slice(1:25),
                 pit_career_1994 %>% select(name, ebWAR) %>% slice(1:25))
colnames(rm_comp) <- c('without rm', 'ebWAR', 'rm after 1950', 'ebWAR', 'rm after 1994', 'ebWAR')
kable(rm_comp) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))

rm_comp <- cbind(pit_career %>% ungroup() %>% arrange(desc(ebWAR)) %>% select(name, efWAR) %>% 
    arrange(desc(efWAR)) %>% slice(1:25), 
                 pit_career_1950 %>% select(name, efWAR) %>% 
    arrange(desc(efWAR))%>% slice(1:25),
                 pit_career_1994 %>% select(name, efWAR) %>% 
    arrange(desc(efWAR))%>% slice(1:25))
colnames(rm_comp) <- c('without rm', 'efWAR', 'rm after 1950', 'efWAR', 'rm after 1994', 'efWAR')
kable(rm_comp) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
