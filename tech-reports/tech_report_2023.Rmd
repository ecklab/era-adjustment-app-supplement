...
## Table 1: Top 25 greatest baseball players from different scources in the paper. 
...
MLBpops_decade <- rbind(c(1870, m[1,2]*2-m[2,2]), m)

```

```{r echo=FALSE}
## bWAR
bat_rookie <- master_batters_nonpara %>% group_by(playerID) %>% 
  summarise(rookie_year = min(yearID))
pit_rookie <- master_pitchers %>% group_by(playerID) %>% 
  summarise(rookie_year = min(yearID))
m_b <- bat_career_nonpara %>% 
  select(name, playerID, ebWAR) %>% left_join(bat_rookie)

m_p <- pit_career %>% 
  select(name, playerID, ebWAR) %>% left_join(pit_rookie)
...
## fWAR
m_b <- bat_career_nonpara %>% 
  select(name, playerID, efWAR) %>% left_join(bat_rookie)

m_p <- pit_career %>% 
  select(name, playerID, efWAR) %>% left_join(pit_rookie)
...
## pre-1950 in top 10
bat_1950_b <- sum(m_ebWAR %>% arrange(desc(ebWAR)) %>% select(rookie_year) %>% slice(1:10) < 1950)
bat_1950_f <- sum(m_efWAR %>% arrange(desc(efWAR)) %>% select(rookie_year) %>% slice(1:10) < 1950)
WAR_rankings <- rbind(WAR_rankings, c(bat_1950_b,bat_1950_f,6,6,6,6))

## pre-1950 in top 25
bat_1950_b <- sum(m_ebWAR %>% arrange(desc(ebWAR)) %>% select(rookie_year) %>% slice(1:25) < 1950)
bat_1950_f <- sum(m_efWAR %>% arrange(desc(efWAR)) %>% select(rookie_year) %>% slice(1:25) < 1950)
WAR_rankings <- rbind(WAR_rankings, c(bat_1950_b,bat_1950_f,15,12,11,17))

## proportion before 1950

n <- MLBpops_decade[MLBpops_decade$year %in% c(1871, seq(1880, 2000, 10), 2005),]
p <- n
p$population[1] <- n$population[1] /10*9
p$population[15] <- n$population[15] /10*5
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))

WAR_rankings <- rbind(WAR_rankings, rep(o$cpp[o$year == 1950],6))
...
career_fullhouse <- (batcar_year %>% 
                       filter(AB >= 5000, rookie_year <= 2012) %>% 
  arrange(desc(BA)))
...
## pre-1950 in top 10
AVG_peak <- sum(peak_fullhouse %>% select(rookie_year) %>% slice(1:10) < 1950)
AVG_career <- sum(career_fullhouse %>% select(rookie_year) %>% slice(1:10) < 1950)
combined_AVG <- rbind(combined_AVG, c(AVG_peak,AVG_career,7,7,6,10))

## pre-1950 in top 25
AVG_peak <- sum(peak_fullhouse %>% select(rookie_year) %>% slice(1:25) < 1950)
AVG_career <- sum(career_fullhouse %>% select(rookie_year) %>% slice(1:25) < 1950)
combined_AVG <- rbind(combined_AVG, c(AVG_peak,AVG_career,18,15,10,24))

## proportion before 1950

n <- MLBpops_decade[MLBpops_decade$year %in% c(1871, seq(1880, 2020, 10), 2023),]
p <- n
p$population[1] <- n$population[1] /10*9
p$population[17] <- n$population[17] /10*3
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p1 <- o$cpp[o$year == 1950]

n <- MLBpops_decade[MLBpops_decade$year %in% c(1871, seq(1880, 2010, 10), 2012),]
p <- n
p$population[1] <- n$population[1] /10*9
p$population[16] <- n$population[16] /10*2
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p2 <- o$cpp[o$year == 1950]

n <- MLBpops_decade[MLBpops_decade$year %in% c(1876, seq(1880, 1980, 10), 1984),]
p <- n
p$population[1] <- n$population[1] /10*4
p$population[13] <- n$population[13] /10*4
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p3 <- o$cpp[o$year == 1950]

n <- MLBpops_decade[MLBpops_decade$year %in% c(1876, seq(1880, 1990, 10), 1997),]
p <- n
p$population[1] <- n$population[1] /10*4
p$population[14] <- n$population[14] /10*7
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p4 <- o$cpp[o$year == 1950]

n <- MLBpops_decade[MLBpops_decade$year %in% c(1901, seq(1910, 1990, 10), 1996),]
p <- n
p$population[1] <- n$population[1] /10*1
p$population[11] <- n$population[11] /10*6
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p5 <- o$cpp[o$year == 1950]
...
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p6 <- o$cpp[o$year == 1950]

combined_AVG <- rbind(combined_AVG, c(p1, p2, p3, p4, p5, p6))

## MLB-eligible population range

combined_AVG <- rbind(combined_AVG, c('1871-2023', '1871-2012', '1876-1984', '1876-1997', '1901-1996', '1871-2012'))
...
career_fullhouse_HR_AB <- batcar_year %>% mutate(HR_AB = HR / AB) %>%
  filter(rookie_year <= 2012, AB >= 5000) %>% left_join(rookie_year) %>% 
  arrange(desc(HR_AB))
...
## pre-1950 in top 10
HR_peak <- sum(bar %>% select(rookie_year) %>% slice(1:10) < 1950)
HR_career <- sum(career_fullhouse_HR_AB %>% select(rookie_year) %>% slice(1:10) < 1950)
combined_HR <- rbind(combined_HR, c(HR_peak,HR_career,1,7,5,4,3))

## pre-1950 in top 25
HR_peak <- sum(bar %>% select(rookie_year) %>% slice(1:25) < 1950)
HR_career <- sum(career_fullhouse_HR_AB %>% select(rookie_year) %>% slice(1:25) < 1950)
combined_HR <- rbind(combined_HR, c(HR_peak,HR_career,5,12,13,12,5))
...
n <- MLBpops_decade[MLBpops_decade$year %in% c(1871, seq(1880, 1990, 10), 1993),]
p <- n
p$population[1] <- n$population[1] /10*9
p$population[14] <- n$population[14] /10*3
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p4 <- o$cpp[o$year == 1950]

n <- MLBpops_decade[MLBpops_decade$year %in% c(1876, seq(1880, 2000, 10), 2003),]
p <- n
p$population[1] <- n$population[1] /10*4
p$population[15] <- n$population[15] /10*3
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p5 <- o$cpp[o$year == 1950]

n <- MLBpops_decade[MLBpops_decade$year %in% c(1876, seq(1880, 1980, 10), 1988),]
p <- n
p$population[1] <- n$population[1] /10*4
p$population[13] <- n$population[13] /10*8
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p6 <- o$cpp[o$year == 1950]

n <- MLBpops_decade[MLBpops_decade$year %in% c(1871, seq(1880, 2000, 10), 2006),]
p <- n
p$population[1] <- n$population[1] /10*9
p$population[15] <- n$population[15] /10*6
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p7 <- o$cpp[o$year == 1950]
...
combined_HR <- rbind(combined_HR, c('1871-2023', '1871-2012', '1901-1996', '1871-1993', '1876-2003', '1876-1988', '1871-2006'))
...
"John McGraw", "Billy Hamilton", "Lou Gehrig", 
"Barry Bonds", "Bill Joyce", "Jud Wilson", "Rogers Hornsby", 
"Ty Cobb", "Jimmie Foxx", "Tris Speaker", "Eddie Collins", 
"Ferris Fain", "Dan Brouthers", "Max Bishop", "Shoeless Joe Jackson", 
"Mickey Mantle", "Mickey Cochrane", "Frank Thomas", 
"Edgar Martinez", "Turkey Stearnes", "Stan Musial", "Cupid Childs", "Wade Boggs"))
...
## pre-1950 in top 10
OBP_career <- sum(OBP_fullhouse %>% select(rookie_year) %>% slice(1:10) < 1950)
combined_OBP <- rbind(combined_OBP, c(OBP_career,8,8))

## pre-1950 in top 25
OBP_career <- sum(OBP_fullhouse %>% select(rookie_year) %>% slice(1:25) < 1950)
combined_OBP <- rbind(combined_OBP, c(OBP_career,16,19))
...
n <- MLBpops_decade[MLBpops_decade$year %in% c(1876, seq(1880, 1990, 10), 1993),]
p <- n
p$population[1] <- n$population[1] /10*4
p$population[14] <- n$population[14] /10*3
o <- p %>% mutate(population = round(population, 2)) %>% 
...
combined_OBP <- rbind(combined_OBP, c('1871-2012', '1876-1993', '1871-2012'))
...
MLBpops_long[MLBpops_long$yearID <= 1900, ]$AL <- MLBpops_long[MLBpops_long$yearID <= 1900,]$NL
m <- data.frame(year = MLBpops_long$yearID, population = apply(MLBpops_long[,2:3], 1, mean) / 1e6)
m <- rbind(c(1870, m[1,2]*2-m[2,2]), m)
...
## Table 2: percent of seasons in which BA failed the Shapiro-Wilk test based on different p-value thresholds in the Supplementary materials.
...
foo <- data.frame(p_value = c(0.05, 0.1, 0.2, 0.3), 
                  prop_season = sapply(c(0.05, 0.1, 0.2, 0.3), function(x) round(sum(normality[,2] < x)/152, 2)))
kable(foo) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
BA_OBP_HR <- cbind(zz_BA %>%
  select(name, BA) %>% slice(1:25), zz_OBP %>%
         select(name, OBP)%>% slice(1:25), zz_HR%>%
         select(name, HR)%>% slice(1:25))
colnames(BA_OBP_HR) <- c('name', 'BA', 'name', 'OBP', 'name', 'HR')

## pre-1950 in top 10
BA_OBP_HR <- rbind(BA_OBP_HR, c(sum(zz_BA$rookie_year[1:10] < 1950), '', sum(zz_OBP$rookie_year[1:10] < 1950), '', sum(zz_HR$rookie_year[1:10] < 1950), ''))

## pre-1950 in top 25
BA_OBP_HR <- rbind(BA_OBP_HR, c(sum(zz_BA$rookie_year[1:25] < 1950), '', sum(zz_OBP$rookie_year[1:25] < 1950), '', sum(zz_HR$rookie_year[1:25] < 1950), ''))
...
BA_OBP_HR <- rbind(BA_OBP_HR, c(p1, '', p2, '', p3, ''))

## MLB-eligible population range

BA_OBP_HR <- rbind(BA_OBP_HR, c('1871-2012','', '1871-2012','', '1871-2012',''))
...
ebWAR_efWAR_b <- cbind(zz_bWAR %>%
  select(name, ebWAR) %>% slice(1:25), zz_fWAR %>%
  select(name, efWAR) %>% slice(1:25))
colnames(ebWAR_efWAR_b) <- c('name', 'ebWAR', 'name', 'efWAR')

## pre-1950 in top 10

ebWAR_efWAR_b <- rbind(ebWAR_efWAR_b, c(sum(zz_bWAR$rookie_year[1:10] < 1950), '', sum(zz_fWAR$rookie_year[1:10] < 1950), ''))

## pre-1950 in top 25
ebWAR_efWAR_b <- rbind(ebWAR_efWAR_b, c(sum(zz_bWAR$rookie_year[1:25] < 1950), '', sum(zz_bWAR$rookie_year[1:25] < 1950), ''))

## proportion before 1950
n <- MLBpops_decade[MLBpops_decade$year %in% c(1871, seq(1880, 2010, 10), 2011),]
p <- n
p$population[1] <- n$population[1] /10*9
p$population[16] <- n$population[16] /10
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p1 <- o$cpp[o$year == 1950]
...
ebWAR_efWAR_b <- rbind(ebWAR_efWAR_b, c(p1, '', p2, ''))
...
zz_ERA <- (pitcar_year %>% arrange(ERA) %>% 
             filter(IP >= 3000))
zz_K <- (pitcar_year %>% arrange(desc(K)))

IP_ERA_K <- cbind(zz_IP %>%
  select(name, IP) %>% slice(1:25), zz_ERA %>%
  select(name, ERA) %>% slice(1:25), zz_K %>%
  select(name, K) %>% slice(1:25))
colnames(IP_ERA_K) <- c('name', 'IP', 'name', 'ERA', 'name', 'SO')

## pre-1950 in top 10

IP_ERA_K <- rbind(IP_ERA_K, c(sum(zz_IP$rookie_year[1:10] < 1950), '', sum(zz_ERA$rookie_year[1:10] < 1950), '', sum(zz_K$rookie_year[1:10] < 1950), ''))

## pre-1950 in top 25
IP_ERA_K <- rbind(IP_ERA_K, c(sum(zz_IP$rookie_year[1:25] < 1950), '', sum(zz_ERA$rookie_year[1:25] < 1950), '', sum(zz_K$rookie_year[1:25] < 1950), ''))
...
n <- MLBpops_decade[MLBpops_decade$year %in% c(1871, seq(1880, 2000, 10), 2008),]
p <- n
p$population[1] <- n$population[1] /10*9
p$population[15] <- n$population[15] /10*8
o <- p %>% mutate(population = round(population, 2)) %>% 
  mutate(cpp = round(cumsum(p$population)/(sum(p$population)), 3))
p2 <- o$cpp[o$year == 1950]
...
IP_ERA_K <- rbind(IP_ERA_K, c(p1, '', p2, '', p3, ''))

## MLB-eligible population range

IP_ERA_K <- rbind(IP_ERA_K, c('1871-2006','', '1871-2012','', '1871-2006',''))
...
ebWAR_efWAR_p <- cbind(zz_bWAR %>%
  select(name, ebWAR) %>% slice(1:25), zz_fWAR %>%
  select(name, efWAR) %>% slice(1:25))
colnames(ebWAR_efWAR_p) <- c('name', 'ebWAR', 'name', 'efWAR')

## pre-1950 in top 10
ebWAR_efWAR_p <- rbind(ebWAR_efWAR_p, c(sum(zz_bWAR$rookie_year[1:10] < 1950), '', sum(zz_fWAR$rookie_year[1:10] < 1950), ''))

## pre-1950 in top 25
ebWAR_efWAR_p <- rbind(ebWAR_efWAR_p, c(sum(zz_bWAR$rookie_year[1:25] < 1950), '', sum(zz_fWAR$rookie_year[1:25] < 1950), ''))
...
ebWAR_efWAR_p <- rbind(ebWAR_efWAR_p, c(p1, '', p2, ''))
...
## Table 3: Top 25 careers according to era-adjusted bWAR (ebWAR), era-adjusted fWAR (efWAR), era-adjusted JAWS computed using bWAR (ebJAWS), and era-adjusted JAWS computed using fWAR (efJAWS).

```{r echo=FALSE}
## bWAR
bat_best_7 <- bat_season_nonpara %>% group_by(playerID) %>% slice_max(ebWAR, n = 7) %>% 
  summarise(best_7 = sum(ebWAR))
m_b <- bat_career_nonpara %>% select(name, playerID, ebWAR) %>% 
  left_join(bat_best_7) %>% mutate(ebJAWS = (ebWAR + best_7)/2) %>% 
  mutate(ebJAWS = round(ebJAWS, 2))

pit_best_7 <- pit_season %>% group_by(playerID) %>% slice_max(ebWAR, n = 7) %>% 
  summarise(best_7 = sum(ebWAR))
m_p <- pit_career %>% select(name, playerID, ebWAR) %>% 
  left_join(pit_best_7) %>% mutate(ebJAWS = (ebWAR + best_7)/2) %>% 
  mutate(ebJAWS = round(ebJAWS, 2))

m_ebWAR<- rbind(m_b, m_p)
index <- which(m_ebWAR$name == "Babe Ruth")
m_ebWAR$ebJAWS[index[1]] <- sum(m_ebWAR$ebJAWS[index])
index <- which(m_ebWAR$name == "Shohei Ohtani")
m_ebWAR$ebJAWS[index[1]] <- sum(m_ebWAR$ebJAWS[index])

## fWAR
bat_best_7 <- bat_season_nonpara %>% group_by(playerID) %>% slice_max(efWAR, n = 7) %>% 
  summarise(best_7 = sum(efWAR))
m_b <- bat_career_nonpara %>% select(name, playerID, efWAR) %>% 
  left_join(bat_best_7) %>% mutate(efJAWS = (efWAR + best_7)/2) %>% 
  mutate(efJAWS = round(efJAWS, 2))

pit_best_7 <- pit_season %>% group_by(playerID) %>% slice_max(efWAR, n = 7) %>% 
  summarise(best_7 = sum(efWAR))
m_p <- pit_career %>% select(name, playerID, efWAR) %>% 
  left_join(pit_best_7) %>% mutate(efJAWS = (efWAR + best_7)/2) %>% 
  mutate(efJAWS = round(efJAWS, 2))

m_efWAR<- rbind(m_b, m_p)
index <- which(m_efWAR$name == "Babe Ruth")
m_efWAR$efJAWS[index[1]] <- sum(m_efWAR$efJAWS[index])
index <- which(m_efWAR$name == "Shohei Ohtani")
m_efWAR$efJAWS[index[1]] <- sum(m_efWAR$efJAWS[index])

kable(cbind(m_ebWAR %>% select(name, ebWAR) %>% arrange(desc(ebWAR)) %>% slice(1:25), 
            m_ebWAR %>% select(name, ebJAWS) %>% arrange(desc(ebJAWS)) %>% slice(1:25), 
            m_efWAR %>% select(name, efWAR) %>% arrange(desc(efWAR)) %>% slice(1:25), 
            m_efWAR %>% select(name, efJAWS) %>% arrange(desc(efJAWS)) %>% slice(1:25))) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
```{r echo = FALSE}
m_b <- batcar_year %>% 
  select(name, playerID, ebWAR, rookie_year) %>% filter(rookie_year <= 2006)
...
index <- which(m_ebWAR$name == "Shohei Ohtani")
m_ebWAR$ebWAR[index[1]] <- sum(m_ebWAR$ebWAR[index])
m_ebWAR <- m_ebWAR %>% arrange(desc(ebWAR))
ggplot(m_ebWAR[1:100,], aes(x=rookie_year)) + geom_histogram(binwidth=2, aes(y=after_stat(density))) +
  geom_density() + labs(title = "Histogram of the best 100 players by their rookie year")
```

```{r echo=FALSE}
ggplot(m_ebWAR[1:1000,], aes(x=rookie_year)) + geom_histogram(binwidth=2, aes(y=after_stat(density))) +
  geom_density() + labs(title = "Histogram of the best 1000 players by their rookie year")
```
...
ref_2023 <- batters_talent_bWAR %>% filter(yearID == 2023) %>% filter(full_time == 'Y') %>% 
  select(yearID, playerID, full_time, comp, pops, thres)
fake_player <- data.frame(yearID = 2023, playerID = "fake01", full_time = 'Y', comp = 0/120, 
                          pops = unique(ref_2023$pops), thres = 350 )
ref_2023 <- rbind(ref_2023, fake_player)
bar <- ref_2023 %>% arrange(comp)

## batter WAR talent

talent_2023 <- talent_computing_nonpara(dataset = bar, component_name = "bWAR", year = 2023, ystar = thresh_fun(component = bar %>% select(comp), component_name = 'bWAR'), alpha = 1.16)
...
adj_0_bWAR_G <- do.call(rbind, mclapply(1871:2023, function(xx){
  int <- career_talent_0(snippet = talent_2023 %>% filter(playerID == 'fake01'), target_year = xx) 
  int
}, mc.cores = ncores))
...
adj_season_G <- do.call(rbind, mclapply(1871:2023, function(xx){
...
## Figure 2: Year Effect on the Era-adjusted WAR in the paper. 
...
ref_2023 <- batters_talent_bWAR %>% filter(yearID == 2023) %>% filter(full_time == 'Y') %>% 
  select(yearID, playerID, full_time, comp, pops, thres)
fake_player <- data.frame(yearID = 2023, playerID = "fake01", full_time = 'Y', comp = 2/120, 
                          pops = unique(ref_2023$pops), thres = 350 )
ref_2023 <- rbind(ref_2023, fake_player)
bar <- ref_2023 %>% arrange(comp)
...
career_talent_2 <- function(snippet, target_year){
  Rev_Aptitude_nonpara <- function(x, ytilde, alpha = 1.16, npop){
...
adj_2_bWAR_G <- do.call(rbind, mclapply(1871:2023, function(xx){
  int <- career_talent_0(snippet = talent_2023 %>% filter(playerID == 'fake01'), target_year = xx) 
  int
}, mc.cores = ncores))
...
adj_2_bWAR <- merge(adj_2_bWAR_G, adj_season_G, by = c('ref_year'))

adj_2_bWAR <- adj_2_bWAR %>% mutate(adj_bWAR = adj_comp * mapped_G) %>% 
  select(ref_year, adj_comp, adj_bWAR)

```

```{r echo=FALSE}
adj_2_bWAR$adj_bWAR <- ifelse(adj_2_bWAR$adj_bWAR < -2, -2, adj_2_bWAR$adj_bWAR)
adj_2_bWAR$adj_bWAR[153] <- 2
adj_2_bWAR_trim <- adj_2_bWAR[-c(111, 150),]
ns_2_bWAR <- lm(adj_bWAR ~ ns(ref_year, df=30), data=adj_2_bWAR_trim)
adj_2_bWAR_trim <- adj_2_bWAR_trim %>% 
  mutate(nn_2_bWAR = predict(ns_2_bWAR, data.frame("ref_year"= adj_2_bWAR_trim$ref_year)))
#adj_0_bWAR <- rbind(adj_0_bWAR, data.frame(ref_year = 2022, adj_bWAR = 0, nn_0_bWAR = 0))
adj_2_bWAR_trim$nn_2_bWAR <- ifelse(adj_2_bWAR_trim$nn_2_bWAR < -2, -2, adj_2_bWAR_trim$nn_2_bWAR)

p <- ggplot(adj_2_bWAR_trim, aes(ref_year, adj_bWAR)) +
  geom_point()
p +  geom_line(aes(x = ref_year, y = nn_2_bWAR)) + labs(x = 'year', y = 'era-adjusted bWAR') +
  geom_point(data = adj_2_bWAR[c(111, 150),], aes(x = ref_year, y = adj_bWAR))

```

```{r echo=FALSE}
adj_2_bWAR_trim <- adj_2_bWAR[-c(111, 150),]
ns_2_bWAR <- lm(adj_comp ~ ns(ref_year, df=15), data=adj_2_bWAR_trim)
adj_2_bWAR_trim <- adj_2_bWAR_trim %>% 
  mutate(nn_2_bWAR = predict(ns_2_bWAR, data.frame("ref_year"= adj_2_bWAR_trim$ref_year)))

p <- ggplot(adj_2_bWAR_trim, aes(ref_year, adj_comp)) +
  geom_point()
p +  geom_line(aes(x = ref_year, y = nn_2_bWAR)) + labs(x = 'year', y = 'era-adjusted bWAR per game') +
  geom_point(data = adj_2_bWAR[c(111, 150),], aes(x = ref_year, y = adj_comp))
```
...
ref_2023 <- batters_talent_fWAR %>% filter(yearID == 2023) %>% filter(full_time == 'Y') %>% 
  select(yearID, playerID, full_time, comp, pops, thres)
fake_player <- data.frame(yearID = 2023, playerID = "fake01", full_time = 'Y', comp = 0/120, 
                          pops = unique(ref_2023$pops), thres = 350 )
ref_2023 <- rbind(ref_2023, fake_player)
...
talent_2023 <- talent_computing_nonpara(dataset = bar, component_name = "fWAR", year = 2023, ystar = thresh_fun(component = bar %>% select(comp), component_name = 'fWAR'), alpha = 1.16)

foo <- batters_talent_fWAR %>% 
  select(yearID, playerID, full_time, comp, pops, thres, WAR_talent, ystar)

adj_0_fWAR_G <- do.call(rbind, mclapply(1871:2023, function(xx){
  int <- career_talent_0(snippet = talent_2023 %>% filter(playerID == 'fake01'), target_year = xx) 
  int
}, mc.cores = ncores))
...
#adj_0_fWAR <- rbind(adj_0_fWAR, data.frame(ref_year = 2023, adj_fWAR = 0, nn_0_fWAR = 0))
...
ref_2023 <- batters_talent_fWAR %>% filter(yearID == 2023) %>% filter(full_time == 'Y') %>% 
  select(yearID, playerID, full_time, comp, pops, thres)
fake_player <- data.frame(yearID = 2023, playerID = "fake01", full_time = 'Y', comp = 2/120, 
                          pops = unique(ref_2023$pops), thres = 342 )
ref_2023 <- rbind(ref_2023, fake_player)
bar <- ref_2023 %>% arrange(comp)
...
adj_2_fWAR_G <- do.call(rbind, mclapply(1871:2023, function(xx){
  int <- career_talent_0(snippet = talent_2023 %>% filter(playerID == 'fake01'), target_year = xx) 
  int
}, mc.cores = ncores))
...
adj_2_fWAR <- merge(adj_2_fWAR_G, adj_season_G, by = c('ref_year'))

adj_2_fWAR <- adj_2_fWAR %>% mutate(adj_fWAR = adj_comp * mapped_G) %>% 
  select(ref_year, adj_comp, adj_fWAR)

```

```{r echo=FALSE}
adj_2_fWAR$adj_fWAR <- ifelse(adj_2_fWAR$adj_fWAR < -2, -2, adj_2_fWAR$adj_fWAR)
adj_2_fWAR$adj_fWAR[153] <- 2
adj_2_fWAR_trim <- adj_2_fWAR[-c(111, 150),]
ns_2_fWAR <- lm(adj_fWAR ~ ns(ref_year, df=30), data=adj_2_fWAR_trim)
adj_2_fWAR_trim <- adj_2_fWAR_trim %>% 
  mutate(nn_2_fWAR = predict(ns_2_fWAR, data.frame("ref_year"= adj_2_fWAR_trim$ref_year)))
#adj_0_fWAR <- rbind(adj_0_fWAR, data.frame(ref_year = 2023, adj_fWAR = 0, nn_0_fWAR = 0))
adj_2_fWAR_trim$nn_2_fWAR <- ifelse(adj_2_fWAR_trim$nn_2_fWAR < -2, -2, adj_2_fWAR_trim$nn_2_fWAR)
adj_2_fWAR_trim$nn_2_fWAR[151] <- 2
p <- ggplot(adj_2_fWAR_trim, aes(ref_year, adj_fWAR)) +
  geom_point()
p +  geom_line(aes(x = ref_year, y = nn_2_fWAR)) + labs(x = 'year', y = 'era-adjusted fWAR') +
  geom_point(data = adj_2_fWAR[c(111, 150),], aes(x = ref_year, y = adj_fWAR))

```

```{r echo=FALSE}
adj_2_fWAR_trim <- adj_2_fWAR[-c(111, 150),]
ns_2_fWAR <- lm(adj_comp ~ ns(ref_year, df=15), data=adj_2_fWAR_trim)
adj_2_fWAR_trim <- adj_2_fWAR_trim %>% 
  mutate(nn_2_fWAR = predict(ns_2_fWAR, data.frame("ref_year"= adj_2_fWAR_trim$ref_year)))

p <- ggplot(adj_2_fWAR_trim, aes(ref_year, adj_comp)) +
  geom_point()
p +  geom_line(aes(x = ref_year, y = nn_2_fWAR)) + labs(x = 'year', y = 'era-adjusted fWAR per game') +
  geom_point(data = adj_2_fWAR[c(111, 150),], aes(x = ref_year, y = adj_comp))
...
## Figure 3: 4 moments of BA in paper
...
## Figure 2: Distribution sensitivity analysis in the paper
...
## Table 8: Comparsion between deteriorated estimation regime and Z-scores in the Supplementary materials.
...
## Table 9: bWAR rankings from Full House Model using different talent generating function in the Supplementary materials.
...
index <- which(m_ebWAR$name == "Shohei Ohtani")
m_ebWAR$ebWAR[index[1]] <- sum(m_ebWAR$ebWAR[index])
m_ebWAR <- m_ebWAR %>% arrange(desc(ebWAR)) %>% select(name, ebWAR) %>% slice(1:25)

m_b <- batcar_year %>% 
  select(name, playerID, efWAR, rookie_year) 
m_p <- pitcar_year %>% 
  select(name, playerID, efWAR, rookie_year) 
m_efWAR<- rbind(m_b, m_p)
index <- which(m_efWAR$name == "Babe Ruth")
...
index <- which(m_efWAR$name == "Shohei Ohtani")
m_efWAR$efWAR[index[1]] <- sum(m_efWAR$efWAR[index])
m_efWAR <- m_efWAR %>% arrange(desc(efWAR)) %>% select(name, efWAR) %>% slice(1:25)

kable(cbind(m_ebWAR, m_efWAR)) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
```{r cache=TRUE, echo=FALSE}
## build common mapping environment
...
```{r cache=TRUE, echo=FALSE}
## compute the talents with some potential talents removed
## after 1950 and after 1994
batters <- bat_dat %>% select(yearID, playerID, lgID, name, age, PA, G, bWAR, pops)
cutoff <- do.call(rbind, mclapply(years, mc.cores = ncores, FUN = function(xx){
    m <- batters %>% filter(yearID == xx) %>% filter(PA >= 75)
    data.frame(thres = median(m$PA), yearID = xx)
...
batters_talent_bWAR_1950 <- do.call(rbind, mclapply(years, mc.cores = ncores, function(yy){
  if (yy < 1950) {
    talent_computing_nonpara(dataset = batters_schell, component_name = "bWAR", year = yy, ystar = thresh_fun(component = batters_schell %>% filter(full_time == 'Y', yearID == yy) %>% select(comp), component_name = 'bWAR'), alpha = 1.16)
  } else{
    talent_computing_nonpara_rm(dataset = batters_schell, component_name = "bWAR", year = yy, ystar = thresh_fun(component = batters_schell %>% filter(full_time == 'Y', yearID == yy) %>% select(comp), component_name = 'bWAR'), alpha = 1.16, rm = seq(10,100,10))
  }
  })) %>% arrange(-WAR_talent)

career_kAB_1st <- do.call(rbind, mclapply(1:30000, function(zz){
    int <- career_talent_nonpara(dataset = batters_talent_bWAR_1950, component_name = 'bWAR', 
                         snippet = batters_talent_bWAR_1950[zz,], alpha = 1.16)
    int
  }, mc.cores = ncores))
...
career_kAB_3rd <- do.call(rbind, mclapply(60001:nrow(batters_talent_bWAR_1950), function(zz){
    int <- career_talent_nonpara(dataset = batters_talent_bWAR_1950, component_name = 'bWAR', 
                         snippet = batters_talent_bWAR_1950[zz,], alpha = 1.16)
    int
  }, mc.cores = ncores)) 
...
mapped_batters_bWAR_1950 <- mapped_batters_1 %>% 
    mutate(adj_bWAR = adj_comp * mapped_G_raw) %>% 
    mutate(adj_bWAR = ifelse(adj_bWAR < min_refbWAR, min_refbWAR, adj_bWAR)) %>%
    mutate(mapped_G_bWAR = round(adj_bWAR / adj_comp))

batters_talent_bWAR_1994 <- do.call(rbind, mclapply(years, mc.cores = ncores, function(yy){
  if (yy < 1994) {
    talent_computing_nonpara(dataset = batters_schell, component_name = "bWAR", year = yy, ystar = thresh_fun(component = batters_schell %>% filter(full_time == 'Y', yearID == yy) %>% select(comp), component_name = 'bWAR'), alpha = 1.16)
  } else{
    talent_computing_nonpara_rm(dataset = batters_schell, component_name = "bWAR", year = yy, ystar = thresh_fun(component = batters_schell %>% filter(full_time == 'Y', yearID == yy) %>% select(comp), component_name = 'bWAR'), alpha = 1.16, rm = seq(10,100,10))
...
career_kAB_1st <- do.call(rbind, mclapply(1:30000, function(zz){
    int <- career_talent_nonpara(dataset = batters_talent_bWAR_1994, component_name = 'bWAR', 
                         snippet = batters_talent_bWAR_1994[zz,], alpha = 1.16)
    int
  }, mc.cores = ncores))
...
career_kAB_3rd <- do.call(rbind, mclapply(60001:nrow(batters_talent_bWAR_1994), function(zz){
    int <- career_talent_nonpara(dataset = batters_talent_bWAR_1994, component_name = 'bWAR', 
                         snippet = batters_talent_bWAR_1994[zz,], alpha = 1.16)
    int
  }, mc.cores = ncores)) 
...
mapped_batters_bWAR_1994 <- mapped_batters_1 %>% 
    mutate(adj_bWAR = adj_comp * mapped_G_raw) %>% 
    mutate(adj_bWAR = ifelse(adj_bWAR < min_refbWAR, min_refbWAR, adj_bWAR)) %>%
    mutate(mapped_G_bWAR = round(adj_bWAR / adj_comp))
```
...
batters <- bat_dat %>% select(yearID, playerID, lgID, name, age, PA, G, bWAR,fWAR,pops)
  ...
  batters_talent_fWAR_1950 <- do.call(rbind, mclapply(years, mc.cores = ncores, function(yy){
    if (yy < 1950) {
      talent_computing_nonpara(dataset = batters_schell, component_name = "fWAR", year = yy, 
                             ystar = thresh_fun(component = batters_schell %>% filter(full_time == 'Y', yearID == yy) %>% select(comp), component_name = 'fWAR'), alpha = 1.16)
    } else{
      talent_computing_nonpara_rm(dataset = batters_schell, component_name = "fWAR", year = yy, 
                             ystar = thresh_fun(component = batters_schell %>% filter(full_time == 'Y', yearID == yy) %>% select(comp), component_name = 'fWAR'), alpha = 1.16, rm = seq(10,100,10))
    }
    
  })) %>% arrange(-WAR_talent)
  
  career_kAB_1st <- do.call(rbind, mclapply(1:30000, function(zz){
    int <- career_talent_nonpara(dataset = batters_talent_fWAR_1950, component_name = 'fWAR', 
                         snippet = batters_talent_fWAR_1950[zz,], alpha = 1.16)
    int
  }, mc.cores = ncores))
  ...
  career_kAB_3rd <- do.call(rbind, mclapply(60001:nrow(batters_talent_fWAR_1950), function(zz){
    int <- career_talent_nonpara(dataset = batters_talent_fWAR_1950, component_name = 'fWAR', 
                         snippet = batters_talent_fWAR_1950[zz,], alpha = 1.16)
    int
  }, mc.cores = ncores)) 
  ...
  mapped_batters_fWAR_1950 <- mapped_batters_1 %>% 
    mutate(adj_fWAR = adj_comp * mapped_G_raw) %>% 
    mutate(adj_fWAR = ifelse(adj_fWAR < min_reffWAR, min_reffWAR, adj_fWAR)) %>%
    mutate(mapped_G_fWAR = round(adj_fWAR / adj_comp))
  
  batters_talent_fWAR_1994 <- do.call(rbind, mclapply(years, mc.cores = ncores, function(yy){
    if (yy < 1994) {
      talent_computing_nonpara(dataset = batters_schell, component_name = "fWAR", year = yy, 
                             ystar = thresh_fun(component = batters_schell %>% filter(full_time == 'Y', yearID == yy) %>% select(comp), component_name = 'fWAR'), alpha = 1.16)
    } else{
  ...
  career_kAB_1st <- do.call(rbind, mclapply(1:30000, function(zz){
    int <- career_talent_nonpara(dataset = batters_talent_fWAR_1994, component_name = 'fWAR', 
                         snippet = batters_talent_fWAR_1994[zz,], alpha = 1.16)
    int
  }, mc.cores = ncores))
  ...
  career_kAB_3rd <- do.call(rbind, mclapply(60001:nrow(batters_talent_fWAR_1994), function(zz){
    int <- career_talent_nonpara(dataset = batters_talent_fWAR_1994, component_name = 'fWAR', 
                         snippet = batters_talent_fWAR_1994[zz,], alpha = 1.16)
    int
  }, mc.cores = ncores)) 
  ...
  mapped_batters_fWAR_1994 <- mapped_batters_1 %>% 
    mutate(adj_fWAR = adj_comp * mapped_G_raw) %>% 
    mutate(adj_fWAR = ifelse(adj_fWAR < min_reffWAR, min_reffWAR, adj_fWAR)) %>%
    mutate(mapped_G_fWAR = round(adj_fWAR / adj_comp))
```
...
```{r cache=TRUE, echo=FALSE}
bWAR_part <- mapped_batters_bWAR_1950 %>%
    mutate(adj_bWAR = round(adj_bWAR, 2)) %>%
    select(yearID, playerID, adj_bWAR, mapped_G_bWAR) 
fWAR_part <- mapped_batters_fWAR_1950 %>%
    mutate(adj_fWAR = round(adj_fWAR, 2)) %>%
    select(yearID, playerID, adj_fWAR, mapped_G_fWAR)
master_batters <- merge(master_batters_nonpara %>% 
                          select(-c(adj_bWAR, mapped_G_bWAR, adj_fWAR, mapped_G_fWAR)), 
                        merge(bWAR_part, fWAR_part, by = c('yearID', 'playerID')), by = c('yearID', 'playerID'))
  
  master_batters <- master_batters %>% 
    mutate(adj_OBP = round((adj_AVG * adj_AB + adj_BB + HBP) / (adj_AB + adj_BB + HBP + SF), 3))
  master_batters$adj_OBP[is.na(master_batters$adj_OBP)] <- 0
  
  master_batters_1950 <- master_batters %>% mutate(adj_BB = ifelse(adj_BB < 0, 0, adj_BB)) %>% 
    mutate(adj_AB = ifelse(mapped_PA < adj_AB, mapped_PA, adj_AB))
  master_batters_1950$mapped_G <- apply(master_batters_1950[,c(16,18)], 1, min)
  
  ## Batters
  batters <- master_batters_1950
 ...
 colnames(bat_season)[5] <- 'AB'
 colnames(bat_season)[8] <- 'BA'
 bat_season_1950 <- bat_season %>% mutate(H = ceiling(AB * BA)) %>%
   mutate(BA = round(H / AB, 3)) %>%
   mutate(BA = ifelse(AB == 0, 0, BA)) %>%
   mutate(OBP = round((H+BB+HBP)/(AB+BB+HBP+SF), 3)) %>%
   mutate(OBP = ifelse(AB+BB+HBP+SF == 0, 0, OBP))
 
  bat_career_1950 <- bat_season_1950 %>% group_by(playerID) %>% 
    summarise(name = unique(name), 
              playerID = unique(playerID), 
              PA = sum(round(PA)), 
              AB = sum(AB), 
  ...
  bat_career_1950 <- bat_career_1950 %>% mutate(BA = ifelse(AB == 0, 0, BA))
  bat_career_1950 <- bat_career_1950 %>% mutate(OBP = ifelse(AB + BB + HBP + SF == 0, 0, OBP))
  
```

```{r cache=TRUE, echo=FALSE}
bWAR_part <- mapped_batters_bWAR_1994 %>%
    mutate(adj_bWAR = round(adj_bWAR, 2)) %>%
    select(yearID, playerID, adj_bWAR, mapped_G_bWAR) 
fWAR_part <- mapped_batters_fWAR_1994 %>%
    mutate(adj_fWAR = round(adj_fWAR, 2)) %>%
    select(yearID, playerID, adj_fWAR, mapped_G_fWAR)
master_batters <- merge(master_batters_nonpara %>% 
                          select(-c(adj_bWAR, mapped_G_bWAR, adj_fWAR, mapped_G_fWAR)), 
  ...
  master_batters_1994 <- master_batters %>% mutate(adj_BB = ifelse(adj_BB < 0, 0, adj_BB)) %>% 
    mutate(adj_AB = ifelse(mapped_PA < adj_AB, mapped_PA, adj_AB))
  master_batters_1994$mapped_G <- apply(master_batters_1994[,c(16,18)], 1, min)
  
  ## Batters
  batters <- master_batters_1994
 ...
 colnames(bat_season)[5] <- 'AB'
 colnames(bat_season)[8] <- 'BA'
 bat_season_1994 <- bat_season %>% mutate(H = ceiling(AB * BA)) %>%
   mutate(BA = round(H / AB, 3)) %>%
   mutate(BA = ifelse(AB == 0, 0, BA)) %>%
   mutate(OBP = round((H+BB+HBP)/(AB+BB+HBP+SF), 3)) %>%
   mutate(OBP = ifelse(AB+BB+HBP+SF == 0, 0, OBP))
 
  bat_career_1994 <- bat_season_1994 %>% group_by(playerID) %>% 
    summarise(name = unique(name), 
              playerID = unique(playerID), 
              PA = sum(round(PA)), 
              AB = sum(AB), 
  ...
  bat_career_1994 <- bat_career_1994 %>% mutate(BA = ifelse(AB == 0, 0, BA))
  bat_career_1994 <- bat_career_1994 %>% mutate(OBP = ifelse(AB + BB + HBP + SF == 0, 0, OBP))
...
pitchers_talent_bWAR_1950 <- do.call(rbind, mclapply(years, mc.cores = ncores, function(yy){
  if (yy < 1950) {
    talent_computing_nonpara(dataset = pitchers_schell, component_name = "bWAR_p", year = yy, 
                             ystar = thresh_fun(component = pitchers_schell %>% 
                                                 filter(full_time =='Y', yearID == yy) %>%
    ...
    talent_computing_nonpara_rm(dataset = pitchers_schell, component_name = "bWAR_p", year = yy, 
                             ystar = thresh_fun(component = pitchers_schell %>% 
                                                 filter(full_time =='Y', yearID == yy) %>%
                                                 select(comp), component_name = 'bWAR_p'), 
                             alpha = 1.16, rm = seq(10,100,10))
  }
    
  })) %>% arrange(-WAR_talent)

career_kAB <- do.call(rbind, mclapply(1:nrow(pitchers_talent_bWAR_1950), function(xx){
    int <- career_talent_nonpara(dataset = pitchers_talent_bWAR_1950, component_name = 'bWAR_p', 
                         snippet = pitchers_talent_bWAR_1950[xx,], alpha = 1.16)
    int
  }, mc.cores = ncores)) 
```
...
mapped_quan_p <- do.call(rbind, mclapply(years, function(xx){
  ...
  mapped_pitchers_bWAR_1950 <- mapped_pitchers_1 %>% 
    mutate(adj_bWAR = adj_comp * mapped_IP_raw) %>%
    mutate(adj_bWAR = ifelse(adj_bWAR < min_refbWAR, min_refbWAR, adj_bWAR)) %>%
    mutate(mapped_IP_bWAR = round(adj_bWAR / adj_comp))

pitchers_talent_bWAR_1994 <- do.call(rbind, mclapply(years, mc.cores = ncores, function(yy){
  if (yy < 1994) {
    talent_computing_nonpara(dataset = pitchers_schell, component_name = "bWAR_p", year = yy, 
                             ystar = thresh_fun(component = pitchers_schell %>% 
                                                 filter(full_time =='Y', yearID == yy) %>%
...
career_kAB <- do.call(rbind, mclapply(1:nrow(pitchers_talent_bWAR_1994), function(xx){
    int <- career_talent_nonpara(dataset = pitchers_talent_bWAR_1994, component_name = 'bWAR_p', 
                         snippet = pitchers_talent_bWAR_1994[xx,], alpha = 1.16)
    int
  }, mc.cores = ncores)) 
  ...
  mapped_pitchers_bWAR_1994 <- mapped_pitchers_1 %>% 
    mutate(adj_bWAR = adj_comp * mapped_IP_raw) %>%
    mutate(adj_bWAR = ifelse(adj_bWAR < min_refbWAR, min_refbWAR, adj_bWAR)) %>%
    mutate(mapped_IP_bWAR = round(adj_bWAR / adj_comp))
```
...
pitchers_talent_fWAR_1950 <- do.call(rbind, mclapply(years, mc.cores = ncores, function(yy){
  if (yy < 1950) {
    talent_computing_nonpara(dataset = pitchers_schell, component_name = "fWAR_p", year = yy, 
                             ystar = thresh_fun(component = pitchers_schell %>% 
                                                 filter(full_time =='Y', yearID == yy) %>%
    ...
    talent_computing_nonpara_rm(dataset = pitchers_schell, component_name = "fWAR_p", year = yy, 
                             ystar = thresh_fun(component = pitchers_schell %>% 
                                                 filter(full_time =='Y', yearID == yy) %>%
...
career_kAB <- do.call(rbind, mclapply(1:nrow(pitchers_talent_fWAR_1950), function(xx){
    int <- career_talent_nonpara(dataset = pitchers_talent_fWAR_1950, component_name = 'fWAR_p', 
                         snippet = pitchers_talent_fWAR_1950[xx,], alpha = 1.16)
    int
  }, mc.cores = ncores)) 
  ...
  mapped_pitchers_fWAR_1950 <- mapped_pitchers_1 %>% 
    mutate(adj_fWAR = adj_comp * mapped_IP_raw) %>%
    mutate(adj_fWAR = ifelse(adj_fWAR < min_reffWAR, min_reffWAR, adj_fWAR)) %>%
    mutate(mapped_IP_fWAR = round(adj_fWAR / adj_comp))
  
  mapped_quan_p_merge <- merge(mapped_pitchers_bWAR_1950 %>% select(yearID, playerID, mapped_IP_bWAR), 
                         mapped_pitchers_fWAR_1950 %>% select(yearID, playerID, mapped_IP_fWAR), 
                         by = c('yearID', 'playerID')) 
  mapped_quan_p_merge$mapped_IP <- apply(mapped_quan_p_merge[,c(3,4)], 1, min)
  mapped_quan_p_1950 <- mapped_quan_p_merge %>% select(yearID, playerID, mapped_IP)
  
  pitchers_talent_fWAR_1994 <- do.call(rbind, mclapply(years, mc.cores = ncores, function(yy){
  if (yy < 1994) {
    talent_computing_nonpara(dataset = pitchers_schell, component_name = "fWAR_p", year = yy, 
                             ystar = thresh_fun(component = pitchers_schell %>% 
                                                 filter(full_time =='Y', yearID == yy) %>%
...
career_kAB <- do.call(rbind, mclapply(1:nrow(pitchers_talent_fWAR_1994), function(xx){
    int <- career_talent_nonpara(dataset = pitchers_talent_fWAR_1994, component_name = 'fWAR_p', 
                         snippet = pitchers_talent_fWAR_1994[xx,], alpha = 1.16)
    int
  }, mc.cores = ncores)) 
  ...
  mapped_pitchers_fWAR_1994 <- mapped_pitchers_1 %>% 
    mutate(adj_fWAR = adj_comp * mapped_IP_raw) %>%
    mutate(adj_fWAR = ifelse(adj_fWAR < min_reffWAR, min_reffWAR, adj_fWAR)) %>%
    mutate(mapped_IP_fWAR = round(adj_fWAR / adj_comp))
  
  mapped_quan_p_merge <- merge(mapped_pitchers_bWAR_1994 %>% select(yearID, playerID, mapped_IP_bWAR), 
                         mapped_pitchers_fWAR_1994 %>% select(yearID, playerID, mapped_IP_fWAR), 
                         by = c('yearID', 'playerID')) 
  mapped_quan_p_merge$mapped_IP <- apply(mapped_quan_p_merge[,c(3,4)], 1, min)
  mapped_quan_p_1994 <- mapped_quan_p_merge %>% select(yearID, playerID, mapped_IP)
```

```{r cache=TRUE, echo=FALSE}
bWAR_part <- mapped_pitchers_bWAR_1950 %>% 
  mutate(adj_bWAR = round(adj_bWAR, 2)) %>% 
  select(yearID, playerID, adj_bWAR)
fWAR_part <- mapped_pitchers_fWAR_1950 %>%
  mutate(adj_fWAR = round(adj_fWAR, 2)) %>% 
  select(yearID,playerID, adj_fWAR) 

master_pitchers_1950 <- merge(master_pitchers %>% select(-c(mapped_IP, adj_bWAR, adj_fWAR)),
                         merge(mapped_quan_p_1950, 
                               merge(bWAR_part, fWAR_part, by = c('yearID', 'playerID')),
                               by = c('yearID', 'playerID')), 
                         by = c('yearID', 'playerID'))
## Pitchers
pitchers <- master_pitchers_1950 %>% 
  mutate(adj_K9 = round(adj_SO/mapped_IP*9,1), 
         K9 = round(SO/IP*9,1), 
         adj_fWAR = round(adj_fWAR, 2))
pitchers <- as.data.frame(pitchers)
...
pit_season_1950 <- pit_season %>% dplyr::select(-c(adj_bWAR, adj_fWAR, adj_ERA, adj_SO, full_time))

pit_career_1950 <- pit_season_1950 %>% group_by(playerID) %>% 
...
```{r cache=TRUE, echo=FALSE}
bWAR_part <- mapped_pitchers_bWAR_1994 %>% 
  mutate(adj_bWAR = round(adj_bWAR, 2)) %>% 
  select(yearID, playerID, adj_bWAR)
fWAR_part <- mapped_pitchers_fWAR_1994 %>%
  mutate(adj_fWAR = round(adj_fWAR, 2)) %>% 
  select(yearID,playerID, adj_fWAR) 

master_pitchers_1994 <- merge(master_pitchers %>% select(-c(mapped_IP, adj_bWAR, adj_fWAR)),
                         merge(mapped_quan_p_1994, 
                               merge(bWAR_part, fWAR_part, by = c('yearID', 'playerID')),
                               by = c('yearID', 'playerID')), 
                         by = c('yearID', 'playerID'))
## Pitchers
pitchers <- master_pitchers_1994 %>% 
  mutate(adj_K9 = round(adj_SO/mapped_IP*9,1), 
         K9 = round(SO/IP*9,1), 
         adj_fWAR = round(adj_fWAR, 2))
pitchers <- as.data.frame(pitchers)
...
pit_season_1994 <- pit_season %>% dplyr::select(-c(adj_bWAR, adj_fWAR, adj_ERA, adj_SO, full_time))

pit_career_1994 <- pit_season_1994 %>% group_by(playerID) %>% 
  summarise(name = unique(name)[1], 
            playerID = unique(playerID), 
            IP = sum(IP), 
            ER = sum(ER), 
...
m_b_1950 <- bat_career_1950 %>% select(name, playerID, ebWAR)
m_p_1950 <- pit_career_1950 %>% select(name, playerID, ebWAR)
m_ebWAR_1950<- rbind(m_b, m_p)
index <- which(m_ebWAR_1950$name == "Babe Ruth")
m_ebWAR_1950$ebWAR[index[1]] <- sum(m_ebWAR_1950$ebWAR[index])
index <- which(m_ebWAR_1950$name == "Shohei Ohtani")
m_ebWAR_1950$ebWAR[index[1]] <- sum(m_ebWAR_1950$ebWAR[index])

m_b_1994 <- bat_career_1994 %>% select(name, playerID, ebWAR)
m_p_1994 <- pit_career_1994 %>% select(name, playerID, ebWAR)
m_ebWAR_1994<- rbind(m_b, m_p)
index <- which(m_ebWAR_1994$name == "Babe Ruth")
m_ebWAR_1994$ebWAR[index[1]] <- sum(m_ebWAR_1994$ebWAR[index])
index <- which(m_ebWAR_1994$name == "Shohei Ohtani")
m_ebWAR_1994$ebWAR[index[1]] <- sum(m_ebWAR_1994$ebWAR[index])

rm_ebWAR <- cbind(m_ebWAR %>% select(name, ebWAR) %>% arrange(desc(ebWAR)) %>% slice(1:25), 
                 m_ebWAR_1950 %>% select(name, ebWAR) %>% arrange(desc(ebWAR)) %>% slice(1:25),
                 m_ebWAR_1994 %>% select(name, ebWAR) %>% arrange(desc(ebWAR)) %>% slice(1:25))
colnames(rm_ebWAR) <- c('without rm', 'ebWAR', 'rm after 1950', 'ebWAR', 'rm after 1994', 'ebWAR')
kable(rm_ebWAR) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
m_b_1950 <- bat_career_1950 %>% select(name, playerID, efWAR)
m_p_1950 <- pit_career_1950 %>% select(name, playerID, efWAR)
m_efWAR_1950<- rbind(m_b, m_p)
index <- which(m_efWAR_1950$name == "Babe Ruth")
m_efWAR_1950$efWAR[index[1]] <- sum(m_efWAR_1950$efWAR[index])
index <- which(m_efWAR_1950$name == "Shohei Ohtani")
m_efWAR_1950$efWAR[index[1]] <- sum(m_efWAR_1950$efWAR[index])

m_b_1994 <- bat_career_1994 %>% select(name, playerID, efWAR)
m_p_1994 <- pit_career_1994 %>% select(name, playerID, efWAR)
m_efWAR_1994<- rbind(m_b, m_p)
index <- which(m_efWAR_1994$name == "Babe Ruth")
m_efWAR_1994$efWAR[index[1]] <- sum(m_efWAR_1994$efWAR[index])
index <- which(m_efWAR_1994$name == "Shohei Ohtani")
m_efWAR_1994$efWAR[index[1]] <- sum(m_efWAR_1994$efWAR[index])

rm_efWAR <- cbind(m_efWAR %>% select(name, efWAR) %>% arrange(desc(efWAR)) %>% slice(1:25), 
                 m_efWAR_1950 %>% select(name, efWAR) %>% arrange(desc(efWAR)) %>% slice(1:25),
                 m_efWAR_1994 %>% select(name, efWAR) %>% arrange(desc(efWAR)) %>% slice(1:25))
colnames(rm_efWAR) <- c('without rm', 'efWAR', 'rm after 1950', 'efWAR', 'rm after 1994', 'efWAR')
kable(rm_efWAR) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
bat_best_7 <- bat_season_1950 %>% group_by(playerID) %>% slice_max(ebWAR, n = 7) %>% 
  summarise(best_7 = sum(ebWAR))
m_b <- bat_career_1950 %>% select(name, playerID, ebWAR) %>% 
  left_join(bat_best_7) %>% mutate(ebJAWS = (ebWAR + best_7)/2) %>% 
  mutate(ebJAWS = round(ebJAWS, 2))
pit_best_7 <- pit_season_1950 %>% group_by(playerID) %>% slice_max(ebWAR, n = 7) %>% 
  summarise(best_7 = sum(ebWAR))
m_p <- pit_career_1950 %>% select(name, playerID, ebWAR) %>% 
  left_join(pit_best_7) %>% mutate(ebJAWS = (ebWAR + best_7)/2) %>% 
  mutate(ebJAWS = round(ebJAWS, 2))
m_ebWAR_1950<- rbind(m_b, m_p)
index <- which(m_ebWAR_1950$name == "Babe Ruth")
m_ebWAR_1950$ebJAWS[index[1]] <- sum(m_ebWAR_1950$ebJAWS[index])
index <- which(m_ebWAR_1950$name == "Shohei Ohtani")
m_ebWAR_1950$ebJAWS[index[1]] <- sum(m_ebWAR_1950$ebJAWS[index])

bat_best_7 <- bat_season_1994 %>% group_by(playerID) %>% slice_max(ebWAR, n = 7) %>% 
  summarise(best_7 = sum(ebWAR))
m_b <- bat_career_1994 %>% select(name, playerID, ebWAR) %>% 
  left_join(bat_best_7) %>% mutate(ebJAWS = (ebWAR + best_7)/2) %>% 
  mutate(ebJAWS = round(ebJAWS, 2))
pit_best_7 <- pit_season_1994 %>% group_by(playerID) %>% slice_max(ebWAR, n = 7) %>% 
  summarise(best_7 = sum(ebWAR))
m_p <- pit_career_1994 %>% select(name, playerID, ebWAR) %>% 
  left_join(pit_best_7) %>% mutate(ebJAWS = (ebWAR + best_7)/2) %>% 
  mutate(ebJAWS = round(ebJAWS, 2))
m_ebWAR_1994<- rbind(m_b, m_p)
index <- which(m_ebWAR_1994$name == "Babe Ruth")
m_ebWAR_1994$ebJAWS[index[1]] <- sum(m_ebWAR_1994$ebJAWS[index])
index <- which(m_ebWAR_1994$name == "Shohei Ohtani")
m_ebWAR_1994$ebJAWS[index[1]] <- sum(m_ebWAR_1994$ebJAWS[index])

rm_ebJAWS <- cbind(m_ebWAR %>% select(name, ebJAWS) %>% arrange(desc(ebJAWS)) %>% slice(1:25), 
                     m_ebWAR_1950 %>% select(name, ebJAWS) %>% arrange(desc(ebJAWS)) %>% slice(1:25), 
                     m_ebWAR_1994 %>% select(name, ebJAWS) %>% arrange(desc(ebJAWS)) %>% slice(1:25))
colnames(rm_ebJAWS) <- c('without rm', 'ebJAWS', 'rm after 1950', 'ebJAWS', 'rm after 1994', 'ebJAWS')
kable(rm_ebJAWS) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
bat_best_7 <- bat_season_1950 %>% group_by(playerID) %>% slice_max(efWAR, n = 7) %>% 
  summarise(best_7 = sum(efWAR))
m_b <- bat_career_1950 %>% select(name, playerID, efWAR) %>% 
  left_join(bat_best_7) %>% mutate(efJAWS = (efWAR + best_7)/2) %>% 
  mutate(efJAWS = round(efJAWS, 2))
pit_best_7 <- pit_season_1950 %>% group_by(playerID) %>% slice_max(efWAR, n = 7) %>% 
  summarise(best_7 = sum(efWAR))
m_p <- pit_career_1950 %>% select(name, playerID, efWAR) %>% 
  left_join(pit_best_7) %>% mutate(efJAWS = (efWAR + best_7)/2) %>% 
  mutate(efJAWS = round(efJAWS, 2))
m_efWAR_1950<- rbind(m_b, m_p)
index <- which(m_efWAR_1950$name == "Babe Ruth")
m_efWAR_1950$efJAWS[index[1]] <- sum(m_efWAR_1950$efJAWS[index])
index <- which(m_efWAR_1950$name == "Shohei Ohtani")
m_efWAR_1950$efJAWS[index[1]] <- sum(m_efWAR_1950$efJAWS[index])

bat_best_7 <- bat_season_1994 %>% group_by(playerID) %>% slice_max(efWAR, n = 7) %>% 
  summarise(best_7 = sum(efWAR))
m_b <- bat_career_1994 %>% select(name, playerID, efWAR) %>% 
  left_join(bat_best_7) %>% mutate(efJAWS = (efWAR + best_7)/2) %>% 
  mutate(efJAWS = round(efJAWS, 2))
pit_best_7 <- pit_season_1994 %>% group_by(playerID) %>% slice_max(efWAR, n = 7) %>% 
  summarise(best_7 = sum(efWAR))
m_p <- pit_career_1994 %>% select(name, playerID, efWAR) %>% 
  left_join(pit_best_7) %>% mutate(efJAWS = (efWAR + best_7)/2) %>% 
  mutate(efJAWS = round(efJAWS, 2))
m_efWAR_1994<- rbind(m_b, m_p)
index <- which(m_efWAR_1994$name == "Babe Ruth")
m_efWAR_1994$efJAWS[index[1]] <- sum(m_efWAR_1994$efJAWS[index])
index <- which(m_efWAR_1994$name == "Shohei Ohtani")
m_efWAR_1994$efJAWS[index[1]] <- sum(m_efWAR_1994$efJAWS[index])

rm_efJAWS <- cbind(m_efWAR %>% select(name, efJAWS) %>% arrange(desc(efJAWS)) %>% slice(1:25), 
                     m_efWAR_1950 %>% select(name, efJAWS) %>% arrange(desc(efJAWS)) %>% slice(1:25), 
                     m_efWAR_1994 %>% select(name, efJAWS) %>% arrange(desc(efJAWS)) %>% slice(1:25))
colnames(rm_efJAWS) <- c('without rm', 'efJAWS', 'rm after 1950', 'efJAWS', 'rm after 1994', 'efJAWS')
kable(rm_efJAWS) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
```{r cache=TRUE, echo=FALSE}
## 0.5 favorite population
batters_schell <- batters_schell
```

```{r cache=TRUE, echo=FALSE}
## parametric distribution with historical league size 
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
                  talent_computing_para(dataset = batters_schell, year = yy, alpha = 1.16)
                })) %>% arrange(-talent)
                ...
                career_kAB <- do.call(rbind, mclapply(c(which(batters_talent_AVG$yearID == 1911), which(batters_talent_AVG$yearID == 1997)), function(zz){
                  int <- career_talent_para(dataset = batters_talent_AVG, 
                                            snippet = batters_talent_AVG[zz,], alpha = 1.16)
                  int
                }, mc.cores = ncores))
        ...
        YES_50_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_50_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_50_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '0.5_favor', 
                                        para = 'para', 
                                        league = 'historical',
                                        diff = round(Tony_Gwynn_1997$adj_AVG - Ty_Cobb_1911$adj_AVG, 3) 
                                        ))

```

```{r cache=TRUE, echo=FALSE}
## parametric distribution with fixed league size 
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        YES_50_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_50_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_50_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '0.5_favor', 
                                        para = 'para', 
...
```{r cache=TRUE, echo=FALSE}
## non-parametric distribution with historical league size 

batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
                                           year = yy, ystar = thresh_fun(component = batters_schell %>% 
                                                                           filter(full_time == 'Y', yearID == yy) %>%
                                                                           select(comp), component_name = 'AVG'), 
                                           alpha = 1.16)
                ...
                career_kAB <- do.call(rbind, mclapply(1:nrow(batters_talent_AVG), function(zz){
                  int <- career_talent_nonpara(dataset = batters_talent_AVG, component_name = 'AVG',
                                               snippet = batters_talent_AVG[zz,], alpha = 1.16)
                  int
                }, mc.cores = ncores))
        ...
        YES_50_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- YES_50_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_50_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '0.5_favor', 
                                        para = 'nonpara', 
...
```{r cache=TRUE, echo=FALSE}
## non-parametric distribution with fixed league size 

batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
                                           year = yy, ystar = thresh_fun(component = batters_schell %>% 
                                                                           filter(full_time == 'Y', yearID == yy) %>%
                                                                           select(comp), component_name = 'AVG'), 
                                           alpha = 1.16)
        ...
        YES_50_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- YES_50_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_50_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '0.5_favor', 
                                        para = 'nonpara', 
...
```{r cache=TRUE, echo=FALSE}
## 0.75 favorite population
batters_schell <- batters_schell %>% 
          select(-pops) %>% 
          left_join(pop_75 %>% 
                      select(year, pop, ALpop), by = c('yearID' = 'year')) %>% 
          mutate(pops = ifelse(lgID == "NL",pop,ALpop))
```
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        YES_75_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_75_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_75_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '0.75_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        YES_75_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_75_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_75_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '0.75_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
        ...
        YES_75_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- YES_75_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_75_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '0.75_favor', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
        ...
        YES_75_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- YES_75_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_75_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '0.75_favor', 
                                        para = 'nonpara', 
...
```{r cache=TRUE, echo=FALSE}
## 100 favorite population
batters_schell <- batters_schell %>% 
          select(-c('pops', 'pop', 'ALpop')) %>% 
          left_join(pop_100 %>% 
                      select(year, pop, ALpop), by = c('yearID' = 'year')) %>% 
          mutate(pops = ifelse(lgID == "NL",pop,ALpop))
```
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        YES_100_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_100_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_100_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '1_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        YES_100_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_100_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_100_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '1_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
        ...
        YES_100_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- YES_100_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_100_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '1_favor', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
        ...
        YES_100_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- YES_100_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_100_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = '1_favor', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        YES_1m_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_1m_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_1m_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = 'constant', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        YES_1m_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_1m_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_1m_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = 'constant', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
        ...
        YES_1m_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- YES_1m_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_1m_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = 'constant', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
        ...
        YES_1m_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- YES_1m_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_1m_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = 'constant', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        YES_erosion_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_erosion_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_erosion_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = 'erosion', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        YES_erosion_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- YES_erosion_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_erosion_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = 'erosion', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
        ...
        YES_erosion_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- YES_erosion_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_erosion_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = 'erosion', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
        ...
        YES_erosion_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- YES_erosion_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- YES_erosion_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'YES', 
                                        pops = 'erosion', 
                                        para = 'nonpara', 
...
```{r cache=TRUE, echo=FALSE}
## without park-factor adjustment
load('bat_dat.RData')
batters <- bat_dat %>% left_join(master_batters_nonpara %>% select(playerID, yearID, adj_AB))
cutoff <- do.call(rbind, mclapply(years, mc.cores = ncores, FUN = function(xx){
    m <- batters %>% filter(yearID == xx) %>% filter(PA >= 75)
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_50_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_50_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_50_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '0.5_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_50_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_50_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_50_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '0.5_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_50_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- NO_50_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_50_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '0.5_favor', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_50_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- NO_50_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_50_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '0.5_favor', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_75_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_75_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_75_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '0.75_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_75_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_75_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_75_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '0.75_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_75_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- NO_75_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_75_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '0.75_favor', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_75_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- NO_75_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_75_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '0.75_favor', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_100_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_100_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_100_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '1_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_100_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_100_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_100_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '1_favor', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_100_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- NO_100_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_100_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '1_favor', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_100_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- NO_100_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_100_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = '1_favor', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_1m_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_1m_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_1m_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = 'constant', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_1m_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_1m_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_1m_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = 'constant', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_1m_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- NO_1m_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_1m_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = 'constant', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_1m_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- NO_1m_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_1m_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = 'constant', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_erosion_para_historical_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_erosion_para_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_erosion_para_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = 'erosion', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){
        ...
        NO_erosion_para_fixed_season <- AVG_part
        
        Ty_Cobb_1911 <- NO_erosion_para_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_erosion_para_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = 'erosion', 
                                        para = 'para', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_erosion_nonpara_historical_season <- AVG_part
        Ty_Cobb_1911 <- NO_erosion_nonpara_historical_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_erosion_nonpara_historical_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = 'erosion', 
                                        para = 'nonpara', 
...
batters_talent_AVG <- do.call(rbind, mclapply(c(1911, 1977:1980, 1982:1989, 1997), mc.cores = ncores, function(yy){talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "AVG", 
        ...
        NO_erosion_nonpara_fixed_season <- AVG_part
        Ty_Cobb_1911 <- NO_erosion_nonpara_fixed_season %>% filter(yearID == 1911, playerID == 'cobbty01')
        Tony_Gwynn_1997 <- NO_erosion_nonpara_fixed_season %>% filter(yearID == 1997, playerID == 'gwynnto01')
        season_diff <- rbind(season_diff, 
                             data.frame(PF = 'NO', 
                                        pops = 'erosion', 
                                        para = 'nonpara', 
...
master_batters_AB <- master_batters_nonpara %>% select(-c(adj_bWAR, mapped_G_bWAR))
bWAR_part <- mapped_batters_bWAR %>%
  mutate(adj_bWAR = round(adj_bWAR, 2)) %>%
  select(yearID, playerID, adj_bWAR, mapped_G_bWAR) 
...
master_batters <- master_batters %>% mutate(adj_BB = ifelse(adj_BB < 0, 0, adj_BB)) %>% 
  mutate(adj_AB = ifelse(mapped_PA < adj_AB, mapped_PA, adj_AB))
master_batters$mapped_G <- apply(master_batters[,c(13,18)], 1, min)
...
historical_0.5_career_bat <- career_bWAR
historical_0.5_career_trimmed_bat <- bat_career_nonpara
```

```{r cache=TRUE, echo=FALSE}
## fixed league size
batters_talent_bWAR <- do.call(rbind, mclapply(years, mc.cores = ncores, function(yy){
  talent_computing_nonpara_fixed(dataset = batters_schell, component_name = "bWAR", year = yy, ystar = thresh_fun(component = batters_schell %>% filter(full_time == 'Y', yearID == yy) %>% select(comp), component_name = 'bWAR'), alpha = 1.16) })) %>% arrange(-WAR_talent)
...
fixed_0.5_career_bat <- career_bWAR
fixed_0.5_career_trimmed_bat <- bat_career_nonpara
...
historical_0.75_career_bat <- career_bWAR
historical_0.75_career_trimmed_bat <- bat_career_nonpara
```
...
fixed_0.75_career_bat <- career_bWAR
fixed_0.75_career_trimmed_bat <- bat_career_nonpara
```
...
historical_1_career_bat <- career_bWAR
historical_1_career_trimmed_bat <- bat_career_nonpara
```
...
fixed_1_career_bat <- career_bWAR
fixed_1_career_trimmed_bat <- bat_career_nonpara
```
...
historical_constant_career_bat <- career_bWAR
historical_constant_career_trimmed_bat <- bat_career_nonpara
```
...
fixed_constant_career_bat <- career_bWAR
fixed_constant_career_trimmed_bat <- bat_career_nonpara
```
...
historical_erosion_career_bat <- career_bWAR
historical_erosion_career_trimmed_bat <- bat_career_nonpara
```
...
fixed_erosion_career_bat <- career_bWAR
fixed_erosion_career_trimmed_bat <- bat_career_nonpara
```
...
career_bWAR <- mapped_pitchers_bWAR %>% group_by(playerID) %>% 
  summarise(name = unique(name),
            ...
            adj_bWAR = sum(adj_bWAR))
master_pitchers_AB <- master_pitchers %>% select(-adj_bWAR)
bWAR_part <- mapped_pitchers_bWAR %>% 
  mutate(adj_bWAR = round(adj_bWAR, 2)) %>% 
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
historical_0.5_career_pit <- career_bWAR
historical_0.5_career_trimmed_pit <- pit_career
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
fixed_0.5_career_pit <- career_bWAR
fixed_0.5_career_trimmed_pit <- pit_career
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
historical_0.75_career_pit <- career_bWAR
historical_0.75_career_trimmed_pit <- pit_career
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
fixed_0.75_career_pit <- career_bWAR
fixed_0.75_career_trimmed_pit <- pit_career
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
historical_1_career_pit <- career_bWAR
historical_1_career_trimmed_pit <- pit_career
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
fixed_1_career_pit <- career_bWAR
fixed_1_career_trimmed_pit <- pit_career
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
historical_constant_career_pit <- career_bWAR
historical_constant_career_trimmed_pit <- pit_career
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
fixed_constant_career_pit <- career_bWAR
fixed_constant_career_trimmed_pit <- pit_career
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
historical_erosion_career_pit <- career_bWAR
historical_erosion_career_trimmed_pit <- pit_career
...
pit_career <- pit_season %>% group_by(playerID) %>% 
  summarise(name = unique(name), 
            ...
            efWAR = sum(efWAR)) %>% 
  arrange(desc(ebWAR))
fixed_erosion_career_pit <- career_bWAR
fixed_erosion_career_trimmed_pit <- pit_career
```

```{r cache=TRUE, echo=FALSE}
career_bWAR_diff <- c()
Willie_Mays <- historical_0.5_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- historical_0.5_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- historical_0.5_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- historical_0.5_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- historical_0.5_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- historical_0.5_career_trimmed_pit %>% filter(playerID == 'ruthba01')

career_bWAR_diff <- rbind(career_bWAR_diff, 
                          data.frame(pops = '0.5_favor', 
                                     league = 'historical', 
...
```{r cache=TRUE, echo=FALSE}
Willie_Mays <- fixed_0.5_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- fixed_0.5_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- fixed_0.5_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- fixed_0.5_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- fixed_0.5_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- fixed_0.5_career_trimmed_pit %>% filter(playerID == 'ruthba01')
...
```{r cache=TRUE, echo=FALSE}
Willie_Mays <- historical_0.75_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- historical_0.75_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- historical_0.75_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- historical_0.75_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- historical_0.75_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- historical_0.75_career_trimmed_pit %>% filter(playerID == 'ruthba01')

career_bWAR_diff <- rbind(career_bWAR_diff, 
                          data.frame(pops = '0.75_favor', 
                                     league = 'historical', 
                                     diff_after = round(Willie_Mays_trimmed$ebWAR - 
                                                          Babe_Ruth_bat_trimmed$ebWAR - 
                                                          Babe_Ruth_pit_trimmed$ebWAR, 2), 
...
```{r cache=TRUE, echo=FALSE}
Willie_Mays <- fixed_0.75_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- fixed_0.75_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- fixed_0.75_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- fixed_0.75_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- fixed_0.75_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- fixed_0.75_career_trimmed_pit %>% filter(playerID == 'ruthba01')
...
```{r cache=TRUE, echo=FALSE}
Willie_Mays <- historical_1_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- historical_1_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- historical_1_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- historical_1_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- historical_1_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- historical_1_career_trimmed_pit %>% filter(playerID == 'ruthba01')

career_bWAR_diff <- rbind(career_bWAR_diff, 
                          data.frame(pops = '1_favor', 
                                     league = 'historical', 
                                     diff_after = round(Willie_Mays_trimmed$ebWAR - 
                                                          Babe_Ruth_bat_trimmed$ebWAR - 
                                                          Babe_Ruth_pit_trimmed$ebWAR, 2), 
...
```{r cache=TRUE, echo=FALSE}
Willie_Mays <- fixed_1_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- fixed_1_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- fixed_1_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- fixed_1_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- fixed_1_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- fixed_1_career_trimmed_pit %>% filter(playerID == 'ruthba01')
...
```{r cache=TRUE, echo=FALSE}
Willie_Mays <- historical_constant_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- historical_constant_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- historical_constant_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- historical_constant_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- historical_constant_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- historical_constant_career_trimmed_pit %>% filter(playerID == 'ruthba01')

career_bWAR_diff <- rbind(career_bWAR_diff, 
                          data.frame(pops = 'constant', 
                                     league = 'historical', 
                                     diff_after = round(Willie_Mays_trimmed$ebWAR - 
                                                          Babe_Ruth_bat_trimmed$ebWAR - 
                                                          Babe_Ruth_pit_trimmed$ebWAR, 2), 
...
```{r cache=TRUE, echo=FALSE}
Willie_Mays <- fixed_constant_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- fixed_constant_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- fixed_constant_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- fixed_constant_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- fixed_constant_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- fixed_constant_career_trimmed_pit %>% filter(playerID == 'ruthba01')
...
```{r cache=TRUE, echo=FALSE}
Willie_Mays <- historical_erosion_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- historical_erosion_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- historical_erosion_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- historical_erosion_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- historical_erosion_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- historical_erosion_career_trimmed_pit %>% filter(playerID == 'ruthba01')

career_bWAR_diff <- rbind(career_bWAR_diff, 
                          data.frame(pops = 'erosion', 
                                     league = 'historical', 
                                     diff_after = round(Willie_Mays_trimmed$ebWAR - 
                                                          Babe_Ruth_bat_trimmed$ebWAR - 
                                                          Babe_Ruth_pit_trimmed$ebWAR, 2), 
...
```{r cache=TRUE, echo=FALSE}
Willie_Mays <- fixed_erosion_career_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat <- fixed_erosion_career_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit <- fixed_erosion_career_pit %>% filter(playerID == 'ruthba01')
Willie_Mays_trimmed <- fixed_erosion_career_trimmed_bat %>% filter(playerID == 'mayswi01')
Babe_Ruth_bat_trimmed <- fixed_erosion_career_trimmed_bat %>% filter(playerID == 'ruthba01')
Babe_Ruth_pit_trimmed <- fixed_erosion_career_trimmed_pit %>% filter(playerID == 'ruthba01')
